...
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: gorilla-utils - version: 0.2.4
include $(CLEAR_VARS)
...
LOCAL_SHARED_LIBRARIES += quest-cosmetic-loader_0_2_3
LOCAL_SHARED_LIBRARIES += zip
LOCAL_SHARED_LIBRARIES += gorilla-utils
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"antitagfreeze"' -DVERSION='"1.1.2"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
